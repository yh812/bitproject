...
class Member(models.Model):
    ...
    address2 = models.CharField( max_length=50, verbose_name="상세주소", null=True, blank=True, default="Null")
    social = models.CharField(max_length=1, verbose_name="소셜로그인여부", null=True, blank=True)
    userimg = models.ImageField(upload_to="portimg/", null=True, verbose_name='프사', blank=True, default="Null")
    def __str__(self):
