...
import random
#board
from board.models import Board, Adboard, Comment, Comment_count, Notice, Recom
...
class MainView(View):
    ...
    def get(self, request):
        ...
        if session_id == None:
            ...
            try:
                recom_user = Recom.objects.get(user_nickname=session_id)
                print("<<<<<<<<<<<<<<<<", recom_user)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board1)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                
                recom_item = Board.objects.get(id = recom_user.recom_board2)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board3)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board4)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board5)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board6)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board7)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board8)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board9)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board10)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board11)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board12)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board13)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board14)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board15)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board16)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board17)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board18)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)   
                recom_item = Board.objects.get(id = recom_user.recom_board19)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
                print("music/paint", recom_board_music, recom_board_paint)
                recom_item = Board.objects.get(id = recom_user.recom_board20)
                if recom_item.board_name =="Music":
                    recom_board_music.append(recom_item)
                else:
                    recom_board_paint.append(recom_item)
               
                recom_board_paint=recom_board_paint[0:8]
                recom_board_music=recom_board_music[0:8]
                print("music/paint", recom_board_music, recom_board_paint)
                print("recom_board_paint", recom_board_paint)
                print("recom_board_music", recom_board_music)
                ...
                context={
                    ...
                    "ad_random":ad_random,
                    "dto":dto,
                    "recom_board_paint" : recom_board_paint,
                    "recom_board_music" : recom_board_music
                    }
            except : 
                print("except")
                context={
...
class MusicView(View):
    ...
    def get(self, request):
        ...
        if sort == "like" :
            ...
            try :
                ...
                paginator = Paginator(recom_board_music, 10)
    ...
    def post(self, request):
        ...
        if categorykey :
            ...
            dtos=Board.objects.filter(board_name='Music',category__contains=categorykey).order_by('-write_dttm')
        print(categorykey)
        print(dtos)
        page = request.GET.get('page', '1')
        paginator = Paginator(dtos, 10)
...
class PaintView(View):
    ...
    def get(self, request):
        ...
        if sort == "like" :
            ...
            try : 
                ...
                recom_item = Board.objects.get(id = recom_user.recom_board1)
                if recom_item.board_name == "Picture":
                    recom_board_paint.append(recom_item)
                ...
                if recom_item.board_name == "Picture":
                    recom_board_paint.append(recom_item)
                page = request.GET.get('page', '1')
                paginator = Paginator(recom_board_paint, 12)  #원래 10개였음.
                page_obj = paginator.get_page(page)
                user = Member.objects.get(nickname=session_id)
                context={
                "session_id" : session_id,
    ...
    def post(self, request):
        ...
        if searchkey == "name_content":
            ...
            dtos = Board.objects.filter(Q(board_name='Picture',title__contains=search) | Q(board_name='Picture',substance__contains=search)).order_by("-write_dttm")
        elif searchkey=="name":
            logger.info(str(session_id)+"*이,"+"Picture"+",게시판종류,"+searchkey+",검색조건,"+search+",검색")
        ...
        if catekey :
            ...
            dtos=Board.objects.filter(board_name='Picture', category__contains=catekey).order_by('-write_dttm')
        page = request.GET.get('page', '1')
        paginator = Paginator(dtos, 12)  #원래 10개였음.
        page_obj = paginator.get_page(page)
...
class FreeView(View):
    ...
    def post(self, request):
        ...
        if searchkey == "name_content":
            ...
            dtos = Board.objects.filter(Q(board_name="Free", title__contains=search) | Q(board_name="Free", substance__contains=search)).order_by("-write_dttm")   
        elif searchkey=="name":
            logger.info(str(session_id)+"*이,"+"Free"+",게시판종류,"+searchkey+",검색조건,"+search+",검색")
